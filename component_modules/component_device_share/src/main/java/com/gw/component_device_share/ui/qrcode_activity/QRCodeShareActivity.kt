package com.gw.component_device_share.ui.qrcode_activity
...
import com.gw.component_device_share.ui.qrcode_activity.adapter.RecentlySharedAdapter
import com.gw.component_device_share.ui.qrcode_activity.vm.QRCodeShareVM
import com.gw.component_family.api.interfaces.IDevice
import com.gw.lib_base_architecture.view.ABaseMVVMDBActivity
import com.gw.lib_qrcode.QRCodeUtil
...
import com.gw.lib_utils.ktx.yyyyMMddHHmmss
import com.tencentcs.iotvideo.http.interceptor.flow.HttpAction
import com.therouter.router.Autowired
import com.therouter.router.Route
import dagger.hilt.android.AndroidEntryPoint
import java.util.Date
import com.gw.component_device_share.databinding.DevShareActivityQrcodeShareBinding as Binding
import com.gw.lib_widget.R as WR
    ...
    override fun initLiveData(viewModel: QRCodeShareVM, savedInstanceState: Bundle?) {
        ...
        viewModel.nearShareUser.observe(this) { list ->
            ...
            if (list.isEmpty()) {
                ...
                mViewBinding.recyclerView.setBackgroundResource(WR.drawable.widget_bg_card_12)
            }
        ...
        viewModel.shareContent.observe(this) { (fromClick, action) ->
            ...
            when (action) {
                is HttpAction.Loading -> {
                    ...
                    mViewBinding.lavLoad.setAnimation(WR.raw.widget_loading)
