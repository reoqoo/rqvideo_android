...
class DeviceRepository @Inject constructor(
    ...
    private val remoteUserMsgDataSource: RemoteUserMsgDataSource,
    private val accountApi: IAccountApi,
    private val appFrontApi: IAppFrontApi,
    ...
    private fun startSyncDeviceStatusService() {
        ...
        try {
            ...
            GwellLogUtils.e(TAG, "startSyncDeviceStatusService error", e)
        }
    }
    ...
    fun loadDeviceShareDetail(
        ...
        return remoteUserMsgDataSource.loadDeviceShareDetail(inviteToken, deviceId)
    }
}