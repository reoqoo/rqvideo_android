        ...
        when (accountType) {
            TYPE_MOBILE -> {
                ...
                if (AppChannelName.isXiaotunApp(appParamApi.getAppName())) {
                    mViewBinding.tvArea.visible(false)
                    mViewBinding.llAccount.visible(true)
                    ...
                    mViewBinding.etAccountNumber.setPadding(textWidth.toInt() + 30.dp, 0, 0, 0)
                } else {
                    mViewBinding.tvArea.visible(true)
                    mViewBinding.llAccount.visible(false)
                    mViewBinding.etAccountNumber.setPadding(0, 0, 0, 0)
                }
            }
