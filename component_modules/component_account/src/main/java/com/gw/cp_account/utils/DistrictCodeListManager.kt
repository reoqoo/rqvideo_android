...
import com.gw.cp_account.http.DistrictCodeListEntity
            ...
            try {
                ...
                `is` = if (language.size > 1) {
                    ...
                    if (languageStr.contains(CHINA_ZH, true)
                        ...
                        app.assets.open("district_code/district_code_tc.txt")
                    } else if (languageStr.contains(CHINA_ZH, true) &&
                        countryStr.contains(CHINA_MAINLAND, true)
                    ) {
                        app.assets.open("district_code/district_code.txt")
                    } else {
                        app.assets.open("district_code/district_code_oversea.txt")
                    }
