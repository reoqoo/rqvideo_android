package com.gw.cp_account.ui.fragment.bind_verify_code
...
import com.gw.cp_account.databinding.AccountFragmentVerifyCodeBinding
import com.gw.cp_account.entity.AccountRegisterType
import com.gw.cp_account.ui.fragment.bind_verify_code.bind_verify.BindVerifyCodeVM
import com.gw.cp_account.widget.verify_code.InputCompleteListener
        ...
        mFgViewModel.countDownCoroutine(
            ...
            onTick = {
                mViewBinding.btnRepeatSend.text = buildString {
                    append(getString(com.gw.resource.R.string.AA0036))
                    append("(")
                    append(it)
                    append("s)")
                }
            ...
            onEnd = {
                ...
                mViewBinding.btnRepeatSend.text = getString(com.gw.resource.R.string.AA0036)
            })
    }
