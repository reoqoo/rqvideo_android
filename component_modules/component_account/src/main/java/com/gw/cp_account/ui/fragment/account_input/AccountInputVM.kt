...
class AccountInputVM @Inject constructor(
    ...
    private fun registerByPhone(phone: String) {
        ...
        SA.track(AccountSaEvent.SEND_VCODE, mapOf(AccountSaEvent.EventAttr.REGISTER_METHOD to "手机号"))
        val type = if (inputFromPage == AccountInputType.ACCOUNT_REGISTER) 0 else 1
        mDistrictBean?.run {
