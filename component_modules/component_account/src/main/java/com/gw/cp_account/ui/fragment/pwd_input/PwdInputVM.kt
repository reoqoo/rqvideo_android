...
//                        AppEnv.APP.sendBroadcast(reLoginIntent)
                        ...
                        HttpErrorCode.ERROR_0 -> {
                            ...
                            t.data?.let {
                                ...
                                toastIntentData.postValue(
                                    ToastIntentData(com.gw.resource.R.string.AA0381)
                                )
                            }
                        }
                        ...
                        HttpErrorCode.ERROR_10902020 -> {
                            ...
                            toastIntentData.postValue(ToastIntentData(com.gw.resource.R.string.AA0382))
                        }

                        HttpErrorCode.ERROR_10901022 -> {
                            // "手机号格式错误"
                            loadDialogState.postValue(IGwBaseVm.LOAD_DIALOG_STATE_CLOSE)
                            toastIntentData.postValue(ToastIntentData(com.gw.resource.R.string.AA0267))
                        }

                        HttpErrorCode.ERROR_999 -> {
                            // "网络繁忙,请稍后再试"
                            loadDialogState.postValue(IGwBaseVm.LOAD_DIALOG_STATE_CLOSE)
                            toastIntentData.postValue(ToastIntentData(com.gw.resource.R.string.AA0381))
                        }
                ...
                override fun onNext(t: LoginResponse?) {
                    when (t?.error_code) {
                        ...
                        HttpErrorCode.ERROR_10902021 -> {
                            // "邮箱已被注册"
                            loadDialogState.postValue(IGwBaseVm.LOAD_DIALOG_STATE_CLOSE)
                            toastIntentData.postValue(ToastIntentData(com.gw.resource.R.string.AA0306))
                        }
...
//                            AppEnv.APP.sendBroadcast(reLogin)
                            ...
                            HttpErrorCode.ERROR_10902011 -> {
                                ...
                                loadDialogState.postValue(IGwBaseVm.LOAD_DIALOG_STATE_CLOSE)
                                toastIntentData.postValue(ToastIntentData(com.gw.resource.R.string.AA0372))
                            }
