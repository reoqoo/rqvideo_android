package com.gw.cp_account.widget.verify_code
...
@JvmOverloads constructor(
    ...
    private val mPaint: Paint = Paint().apply {
        ...
        color = ContextCompat.getColor(context, com.gw.resource.R.color.color_000000_90)
    }
    ...
    override fun onAttachedToWindow() {
        ...
        tvValue.setBackgroundColor(ContextCompat.getColor(context, com.gw.resource.R.color.transparent))
        tvValue.gravity = Gravity.CENTER
        tvValue.setTextColor(ContextCompat.getColor(context, com.gw.resource.R.color.color_000000))
        ...
        val line = View(context).apply {
            setBackgroundColor(ContextCompat.getColor(context, com.gw.resource.R.color.color_000000_20))
        }
