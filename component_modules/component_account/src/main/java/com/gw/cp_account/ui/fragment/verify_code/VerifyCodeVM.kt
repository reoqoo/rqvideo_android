package com.gw.cp_account.ui.fragment.verify_code
...
import com.gw.cp_account.entity.AccountInputType.ACCOUNT_FORGET
import com.gw.cp_account.entity.AccountInputType.ACCOUNT_REGISTER
import com.gw.cp_account.entity.AccountRegisterType
import com.gw.cp_account.http.*
...
import com.gw.lib_http.HttpErrorCode.ERROR_0
import com.gw.lib_http.HttpErrorCode.ERROR_10902009
import com.gw.lib_http.HttpErrorCode.ERROR_10902029
...
class VerifyCodeVM @Inject constructor(
    ...
    private fun registerByPhone(phone: String) {
        val type = if (fromPage == ACCOUNT_REGISTER) 0 else 1
        mDistrictBean?.run {
            ...
            override fun onNext(t: VerifyCodeResponse?) {
                ...
                when (t?.code.toString()) {
                    ...
                    ERROR_10902009, ERROR_10902029 -> {
                        // 手机 邮件验证码不正确
                        toastIntentData.postValue(ToastIntentData(com.gw.resource.R.string.AA0390))
                    }
                }
            }
