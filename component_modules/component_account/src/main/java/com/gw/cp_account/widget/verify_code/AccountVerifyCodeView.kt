...
@JvmOverloads constructor(
    ...
    private val editText = EditText(context).apply {
        ...
        setBackgroundColor(ContextCompat.getColor(context, com.gw.resource.R.color.transparent))
        setTextColor(ContextCompat.getColor(context, com.gw.resource.R.color.transparent))
    ...
    init {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            val cursor: Drawable? = context.getDrawable(R.drawable.edit_cursor_bg_transparent)
            editText.textCursorDrawable = cursor
        } else {
            try {
                val field: Field = TextView::class.java.getDeclaredField("mCursorDrawableRes")
                field.isAccessible = true
                field.set(editText, R.drawable.edit_cursor_bg_transparent)
            } catch (e: Exception) {
