package com.gw.cp_account.ui.activity.bind_account

import android.os.Bundle
import androidx.lifecycle.ViewModel
import androidx.navigation.fragment.NavHostFragment
import com.gw.cp_account.R
import com.gw.cp_account.databinding.AccountActivityBindBinding
import com.gw.cp_account.entity.ParamConstants
import com.gw.cp_account.entity.ParamConstants.PARAM_ACCOUNT_INFO
import com.gw.cp_account.entity.ParamConstants.PARAM_BIND_TYPE
import com.gw.cp_account.ui.activity.bind_account.vm.BindAccountVM
...
class BindAccountActivity : ABaseMVVMDBActivity<AccountActivityBindBinding, BindAccountVM>() {
    ...
    override fun initData(savedInstanceState: Bundle?) {
        ...
        navHostFragment?.navController?.setGraph(R.navigation.account_bind_graph, bundle)
    }
