package com.gw.cp_account.ui.activity.show_bind_account
...
import com.gw.cp_account.databinding.AccountActivityShowAccountBinding
import com.gw.cp_account.entity.ParamConstants
import com.gw.cp_account.entity.ParamConstants.PARAM_BIND_TYPE
import com.gw.cp_account.entity.ParamConstants.TYPE_MOBILE
import com.gw.cp_account.ui.activity.show_bind_account.vm.ShowAccountVM
    ...
    override fun initData(savedInstanceState: Bundle?) {
        ...
        when (accountType) {
            TYPE_MOBILE -> {
                ...
                mViewBinding.ivIcon.setImageResource(R.drawable.icon_bind_mobile)
            ...
            ParamConstants.TYPE_EMAIL -> {
                ...
                mViewBinding.ivIcon.setImageResource(R.drawable.icon_bind_email)
